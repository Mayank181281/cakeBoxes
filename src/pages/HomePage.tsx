...
const HomePage = () => {
  ...
  const rawCustomizedBoxesProducts = getProductsByCategory('customized-boxes');
  const customizedBoxesProducts = sortProductsByDimensions(rawCustomizedBoxesProducts);
