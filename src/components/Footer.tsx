                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">@rkpackagings</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h5 className="font-semibold text-white">WhatsApp Channel</h5>
                      <p className="text-gray-300 text-sm">Join for Updates</p>
                    </div>
                  </div>
                  <div className="text-gray-400">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
